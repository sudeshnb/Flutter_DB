...
import 'package:mongo_test/realm/schemas.dart';
import 'package:mongo_test/realm/realm_services.dart';
import 'package:mongo_test/components/widgets.dart';
...
class ModifyItemForm extends StatefulWidget {
  ...
  @override
  State createState() => _ModifyItemFormState();
}
...
class _ModifyItemFormState extends State<ModifyItemForm> {
  ...
  void initState() {
    ...
    _isCompleteController = ValueNotifier<bool>(widget.item.isComplete)
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      deleteButton(context,
                          onPressed: () =>
                              delete(realmServices, widget.item, context)),
  ...
  Future<void> update(BuildContext context, RealmServices realmServices,
    ...
    if (_formKey.currentState!.validate()) {
      await realmServices
          .updateItem(item, summary: summary, isComplete: isComplete)
